  ...
  <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      ...
      <a class="block flex-shrink-0 lg:hidden" href="index.html">
        <img src="/img/logo/logo-icon.svg" alt="Logo" />
      </a>
    </div>
    <div class="hidden sm:block">
      <button class="inline-flex items-center justify-center gap-2.5 rounded-md bg-primary py-1 px-5 text-center font-medium text-white hover:bg-opacity-90 ">
        <svg class="fill-current dark:fill-bodydark dark:hover:fill-primary" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
        <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
          <span class="hidden text-right lg:block">
            <span class="block text-sm font-medium text-black dark:text-white">{{ $name }}</span>
            <span class="block text-xs font-medium">{{ $role_name }}</span>
          </span>
