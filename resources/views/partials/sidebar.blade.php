            ...
            <li>
              ...
              <div class="overflow-hidden" :class="(selected === 'Users') ? 'block' :'hidden'">
                <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white
                            @php echo in_array(route_name(), ['permission.index', 'permission.create.form', 'permission.update.form']) ? 'text-white' : '' @endphp" href="{{ route('permission.index') }}">Permission</a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white
