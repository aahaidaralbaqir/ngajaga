        ...
        Transaksi 
              ...
              >
                <ul class="mt-4 mb-3 flex flex-col gap-2 pl-6">
                  <li>
                    <a
                      class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white @php echo in_array(route_name(), ['transaction.type.index', 'transaction.type.create.form', 'transaction.type.update.form']) ? 'text-white' : '' @endphp"
