@push('styles')
	<link rel="stylesheet" href="{{ URL::asset('css/apex.css') }}">
@endpush
...
<main>
	...
	<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
		<div class="mb-5">
			...
			<p class="text-sm font-medium">Rangkuman Informasi</p>
		</div>
		<div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5 mb-5">
			<!-- Card Item Start -->
			  ...
			  <div class="mt-4 flex items-end justify-between">
				<div>
				  <h4 class="text-title-md font-bold text-black dark:text-white">
					{{ $dashboard_summary['summary']['amount']['in'] }}
				  </h4>
				  <span class="text-sm font-medium">Total Dana Masuk</span>
				</div>
			...
			<div class="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
			  ...
			  <div class="mt-4 flex items-end justify-between">
				<div>
				  <h4 class="text-title-md font-bold text-black dark:text-white">
					{{ $dashboard_summary['summary']['amount']['out'] }}
				  </h4>
				  <span class="text-sm font-medium">Total Dana Keluar</span>
				</div>
			...
			<div class="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
			  ...
			  <div class="mt-4 flex items-end justify-between">
				<div>
				  <h4 class="text-title-md font-bold text-black dark:text-white">
					{{ $dashboard_summary['summary']['transaction_type'] }}
				  </h4>
				  <span class="text-sm font-medium">Total Jenis Transaksi</span>
				</div>
			...
			<div class="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
			  ...
			  <div class="mt-4 flex items-end justify-between">
				<div>
				  <h4 class="text-title-md font-bold text-black dark:text-white">
					{{ $dashboard_summary['summary']['user'] }}
				  </h4>
		...
		<div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
			<div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
				<div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
					...
					<div class="flex min-w-47.5">
						...
						<div class="w-full">
						<p class="font-semibold text-primary">Total Transaksi Masuk</p>
						<p class="text-sm font-medium">{{ $dashboard_summary['summary']['amount']['total_in'] }}</p>
						</div>
					</div>
					<div class="flex min-w-47.5">
						<span
						...
						<div class="w-full">
						<p class="font-semibold text-secondary">Total Transaksi Keluar</p>
						<p class="text-sm font-medium">{{ $dashboard_summary['summary']['amount']['total_out'] }}</p>
						</div>
					</div>
					</div>	
				</div>
			...
			<div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-4">
				...
				<div class="-mx-8 flex flex-wrap items-center justify-center gap-y-3" id="donut-label">
