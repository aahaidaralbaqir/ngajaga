...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('heroes', function () {
  return {
    show_preview: false,
    image_url: '',
    handleChangeImage: function handleChangeImage(e) {
      var file = e.target.files[0];
      if (file) {
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('activity', function () {
  return {
    ...
    changeRecurring: function changeRecurring(e) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknaruto"] = self["webpackChunknaruto"] || [];
