...
window.addEventListener('DOMContentLoaded', function () {
  var dropdown = document.querySelectorAll('[role="dropdown"]');
  dropdown.forEach(function (item) {
    item.addEventListener('click', function (event) {
      event.preventDefault();
      var targetId = item.getAttribute('data-id');
      var targetName = item.getAttribute('data-name');
      var dropdownContents = document.querySelectorAll('[role="dropdown-content"]');
  ...
  function createToastSuccess(description) {
    var toast = document.createElement('div');
    toast.id = 'toast';
    toast.className = 'flex w-full max-w-sm p-4 toast toast-success gap-2';
  ...
  errorMessages.forEach( /*#__PURE__*/function () {
  ...
  successMessages.forEach( /*#__PURE__*/function () {
