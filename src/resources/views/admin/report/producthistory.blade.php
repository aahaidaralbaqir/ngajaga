    ...
    <div class="w-4/5">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center justify-between gap-5 relative">
                @if (in_array(\App\Constant\Permission::DOWNLOAD_STOCK_PRODUCT_ACTIVITY, $user['permission'])) 
                ...
                @endif
                @if (in_array(\App\Constant\Permission::FILTER_STOCK_PRODUCT_ACTIVITY, $user['permission'])) 
                    @if ($has_filter)
