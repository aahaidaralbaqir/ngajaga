    ...
    <div class="w-4/5">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center justify-between gap-5 relative">
                @if (in_array(\App\Constant\Permission::DOWNLOAD_STOCK_PRODUCT, $user['permission'])) 
                ...
                @endif
                @if (in_array(\App\Constant\Permission::FILTER_STOCK_PRODUCT, $user['permission']))
                    @if ($has_filter)
            ...
            <tbody>
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td>
                            @if (in_array(\App\Constant\Permission::VIEW_STOCK_PRODUCT_ACTIVITY, $user['permission']))  
                                <div class="relative">
