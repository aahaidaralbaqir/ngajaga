        ...
        <div class="w-4/5">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center justify-between gap-5 relative">
                    <a href="{{ route('shelf.index') }}" class="button text-base text-black p-3 rounded border border-black relative flex gap-2">
        ...
        <section class="w-4/5">
                <section class="flex gap-2 justify-between">
                    <header class="text-[#000000] font-light flex-1">
                        <h1 class="text-2xl mb-2 font-normal">Informasi Rak</h1>
                        <p>
                            Simpan dan susun produkmu sesui dengan rak nya. Rak dibuat untuk
                            mempermudah pengguna dalam mencari produk
                        </p>
                        <br>
