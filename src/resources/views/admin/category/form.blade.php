        ...
        <div class="w-4/5">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center justify-between gap-5 relative">
                    <a href="{{ route('category.index') }}" class="button text-base text-black p-3 rounded border border-black relative flex gap-2">
        ...
        <section class="w-4/5">
                <section class="flex gap-2 justify-between">
                    <header class="text-[#000000] font-light flex-1">
                        <h1 class="text-2xl mb-2 font-normal">Informasi Kategori</h1>
                        <p>
                            Kategorikan produk mu berdasarkan jenis barang nya 
                            <br>
                        </p>
                        <br>
                        Pengkategorian membantu kamu mencari dan mengatur produk mu
                    </header>
