    ...
    <div class="w-4/5">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center justify-between gap-5 relative">
                @if (in_array(\App\Constant\Permission::SEARCH_CUSTOMER, $user['permission']))
                    @if ($has_filter)
                ...
                @endif
                @if (in_array(\App\Constant\Permission::CREATE_CUSTOMER, $user['permission']))
                    <a class="button text-base bg-[#ff91e7] text-black p-3 rounded border border-black" href="{{ route('customer.create.form') }}">Buat Pelanggan Baru</a>
                @endif
            </div>
        </div>
    </div>
            ...
            <tbody>
                @foreach($customers as $customer)
                    <tr>
                        ...
                        <td class="relative">
                            @if (in_array(\App\Constant\Permission::UPDATE_CUSTOMER, $user['permission']))
                                ...
                                <div class="menu hidden w-[220px] left-[0px]" data-id="{{ $customer->id }}" data-name="action" role="dropdown-content">
                                    <a href="{{ route('customer.edit.form', ['customerId' => $customer->id]) }}" class="menu-item">
