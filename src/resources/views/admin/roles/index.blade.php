    ...
    <div class="w-4/5">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center justify-between gap-5 relative">
                ...
                <button class="button text-base bg-[#ff91e7] text-black p-3 rounded border border-black">Buat Peran</button>
            </div>
        </div>
        <div class="tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex gap-2 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" width="24" height="24" viewBox="0 0 24 24" fill="{{ $role->status == 1 ? 'black'  : 'none' }}"" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle"><circle cx="12" cy="12" r="10"/></svg>
                                <span>
