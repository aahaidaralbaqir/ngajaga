        ...
        <nav class="mt-2" x-data="{selected: 'Dashboard'}" x-init="
            ...
            <div>
                <ul class="mb-6 flex flex-col">
                    ...
                    <li class="border-t border-[#808080] px-5 py-4">
                        <a class="hover:text-[#ff91e7] group relative flex items-center gap-2.5 rounded-sm   text-sm duration-300 ease-in-out   dark:hover:bg-meta-4 {{ in_array(route_name(), ['transaction.create.form', 'transaction.customer']) ? 'text-[#ff91e7]' : 'text-bodydark1' }}" href="{{ route('transaction.create.form') }}">
