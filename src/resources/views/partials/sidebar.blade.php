        ...
        <nav class="mt-2" x-data="{selected: 'Dashboard'}" x-init="
            ...
            <div>
                <ul class="mb-6 flex flex-col">
                    ...
                    <li class="border-t border-[#808080] px-5 py-4">
                        <a class="group relative flex items-center gap-2.5 rounded-sm  hover:text-[#ff91e7] text-sm  duration-300 ease-in-out dark:hover:bg-meta-4 {{ in_array(route_name(), ['permission.index', 'permission.create.form', 'permission.edit.form', 'roles.index', 'roles.create.form', 'roles.update.form', 'user.index']) ? 'text-[#ff91e7]' : 'text-bodydark1' }}" href="{{ route('permission.index') }}">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="border-t border-[#808080] px-5 py-4">
                        <a class="group relative flex items-center gap-2.5 rounded-sm  hover:text-[#ff91e7] text-sm duration-300 ease-in-out dark:hover:bg-meta-4 {{ in_array(route_name(), ['product.index', 'category.index', 'shelf.index']) ? 'text-[#ff91e7]' : 'text-bodydark1' }}" href="{{ route('product.index') }}">
