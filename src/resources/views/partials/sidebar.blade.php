<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'" class="absolute left-0 top-0 z-9999 flex h-screen w-48 flex-col overflow-y-hidden bg-[#000000] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0" @click.outside="sidebarToggle = false">
        ...
        <nav class="mt-2" x-data="{selected: 'Dashboard'}" x-init="
            ...
            <div>
                <ul class="mb-6 flex flex-col">
                    ...
                    @if (in_array(\App\Constant\Permission::VIEW_CASH_ACCOUNT, $user['permission']))
                        <li class="border-t border-[#808080] px-5 py-4">
                    ...
                    @if(in_array(\App\Constant\Permission::VIEW_PRODUCT, $user['permission']) || in_array(\App\Constant\Permission::VIEW_CATEGORY, $user['permission']) || in_array(\App\Constant\Permission::VIEW_SHELF, $user['permission']))
                        ...
                        @endphp
                        <li class="border-t border-[#808080] px-5 py-4">
                            <a class="group relative flex items-center gap-2.5 rounded-sm  hover:text-[#ff91e7] text-sm duration-300 ease-in-out dark:hover:bg-meta-4 {{ in_array(route_name(), ['product.index', 'category.index', 'category.create.form', 'category.edit.form', 'shelf.index', 'shelf.create.form', 'shelf.edit.form', 'product.index', 'product.create.form', 'product.edit.form', 'product.price.form']) ? 'text-[#ff91e7]' : 'text-bodydark1' }}" href="{{ route($target_route) }}">
                    ...
                    @if(in_array(\App\Constant\Permission::VIEW_SUPPLIER, $user['permission']) || in_array(\App\Constant\Permission::VIEW_ORDER_INVOICE, $user['permission']) || in_array(\App\Constant\Permission::VIEW_PURCHASE_INVOICE, $user['permission']))
                        ...
                        @endphp
                        <li class="border-t border-[#808080] px-5 py-4">
                            <a class="hover:text-[#ff91e7] group relative flex items-center gap-2.5 rounded-sm   text-sm duration-300 ease-in-out   dark:hover:bg-meta-4 {{ in_array(route_name(), ['supplier.index', 'supplier.create.form', 'supplier.edit.form', 'purchase.index', 'purchase.create.form', 'purchase.edit.form', 'invoice.index', 'invoice.create.form', 'invoice.edit.form']) ? 'text-[#ff91e7]' : 'text-bodydark1' }}" href="{{ route($target_route) }}">
                    ...
                    <li class="border-t border-[#808080] px-5 py-4">
                        <a class="hover:text-[#ff91e7] group relative flex items-center gap-2.5 rounded-sm text-sm duration-300 ease-in-out   dark:hover:bg-meta-4 {{ in_array(route_name(), ['transaction.create.form', 'transaction.customer', 'transaction.index', 'transaction.edit.form', 'transaction.debt.index', 'transaction.debt.create.form']) ? 'text-[#ff91e7]' : 'text-bodydark1' }}" href="{{ route('transaction.index') }}">
