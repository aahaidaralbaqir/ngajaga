        ...
        <nav class="mt-2" x-data="{selected: 'Dashboard'}" x-init="
            ...
            <div>
                <ul class="mb-6 flex flex-col">
                    ...
                    <li class="border-t border-[#808080] px-5 py-4">
                        <a href="{{ route('product.report') }}" class="hover:text-[#ff91e7] group relative flex items-center gap-2.5 rounded-sm text-sm duration-300 ease-in-out   dark:hover:bg-meta-4 {{ in_array(route_name(), ['product.report']) ? 'text-[#ff91e7]' : 'text-bodydark1' }}">
                            <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
