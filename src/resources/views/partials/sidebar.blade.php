        ...
        <nav class="mt-2" x-data="{selected: 'Dashboard'}" x-init="
            ...
            <div>
                <ul class="mb-6 flex flex-col">
                    <li class="border-y border-[#808080] px-5 py-4">
                        <a class="group relative flex items-center gap-2.5 rounded-sm   text-sm text-bodydark1 duration-300 ease-in-out  hover:text-[#ff91e7] dark:hover:bg-meta-4 @php echo route_is('admin') ? 'bg-graydark dark:bg-meta-4' : '' @endphp" href="{{ route('admin') }}">
                    ...
                    <li class="border-y border-[#808080] px-5 py-4">
                        <a class="group relative flex items-center gap-2.5 rounded-sm  hover:text-[#ff91e7] text-sm text-bodydark1 duration-300 ease-in-out   dark:hover:bg-meta-4" href="{{ route('user.index') }}">
                    ...
                    <li class="border-y border-[#808080] px-5 py-4">
                        <a class="group relative flex items-center gap-2.5 rounded-sm  hover:text-[#ff91e7] text-sm text-bodydark1 duration-300 ease-in-out   dark:hover:bg-meta-4" href="#" @click.prevent="selected = (selected === 'Users' ? '':'Users')">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="overflow-hidden" :class="(selected === 'Users') ? 'block' :'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5  hover:text-[#ff91e7] rounded-md px-4 text-sm text-bodydark2 duration-300 ease-in-out hover:text-white
                    ...
                    <li class="border-y border-[#808080] px-5 py-4">
                        <a class="group relative flex items-center gap-2.5 rounded-sm  hover:text-[#ff91e7] text-sm text-bodydark1 duration-300 ease-in-out   dark:hover:bg-meta-4" href="#" @click.prevent="selected = (selected === 'Produk' ? '':'Produk')">
                        ...
                        <div class="overflow-hidden" :class="(selected === 'Produk') ? 'block' :'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="hover:text-[#ff91e7] group relative flex items-center gap-2.5 rounded-md px-4 text-sm text-bodydark2 duration-300 ease-in-out hover:text-white
                    ...
                    <li class="border-y border-[#808080] px-5 py-4">
                        <a class="hover:text-[#ff91e7] group relative flex items-center gap-2.5 rounded-sm   text-sm text-bodydark1 duration-300 ease-in-out   dark:hover:bg-meta-4 @php echo in_array(route_name(), ['user.index', 'user.create.form', 'user.update.form']) ? 'bg-graydark dark:bg-meta-4' : '' @endphp" href="{{ route('user.index') }}">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="border-y border-[#808080] px-5 py-4">
                        <a href="{{ route('beneficiary.index') }}" class=" hover:text-[#ff91e7] group relative flex items-center gap-2.5 rounded-sm   text-sm text-bodydark1 duration-300 ease-in-out   dark:hover:bg-meta-4 @php echo in_array(route_name(), ['beneficiary.index', 'beneficiary.create.form', 'beneficiary.update.form']) ? 'bg-graydark dark:bg-meta-4' : '' @endphp" >
                            <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
